...
public class AchievementManager {
        ...
        if (!achievementsFile.exists()) {
            try {
                ...
                try {
                    ...
                    plugin.getLogger().warning("achievements.yml not found in jar, creating a default file");
                    createDefaultAchievementsFile();
                }
            } catch (Exception e) {
                plugin.getLogger().warning("Failed to save default achievements.yml: " + e.getMessage());
                
                // Create the file manually if saveResource fails
                try {
                    // Copy achievements.yml content from embedded resource
                    InputStream inputStream = plugin.getResource("achievements.yml");
                    if (inputStream != null) {
                        Files.copy(inputStream, achievementsFile.toPath(), StandardCopyOption.REPLACE_EXISTING);
                        plugin.getLogger().info("Successfully created achievements.yml manually.");
                    } else {
                        // Create a basic achievement file
                        createDefaultAchievementsFile();
                    }
                } catch (Exception ex) {
                    plugin.getLogger().warning("Failed to create achievements.yml: " + ex.getMessage());
                    createDefaultAchievementsFile();
                }
            }
        }
    ...
    public boolean unlockAchievement(Clan clan, String achievementId) {
        ...
        AnimationUtils.playClanAchievementAnimation(clan, achievement);
    ...
    /**
     * Creates a default achievements.yml file when it can't be loaded from resources.
     */
    private void createDefaultAchievementsFile() {
        try {
            plugin.getLogger().info("Creating default achievements.yml file...");
            ...
            FileWriter writer = new FileWriter(achievementsFile);
            writer.write("# ClanPlugin Achievement Configuration\n");
            writer.write("# This file defines achievements that can be earned by clan members\n\n");
            
            // General achievements
            writer.write("# General achievements\n");
            writer.write("first_clan:\n");
            writer.write("  name: \"Founding Father\"\n");
            writer.write("  description: \"Create your first clan\"\n");
            writer.write("  category: GENERAL\n");
            writer.write("  difficulty: EASY\n");
            writer.write("  exp_reward: 100\n");
            writer.write("  rep_reward: 10\n\n");
            
            writer.write("recruit_members:\n");
            writer.write("  name: \"Recruitment Drive\"\n");
            writer.write("  description: \"Have at least 5 members in your clan\"\n");
            writer.write("  category: GENERAL\n");
            writer.write("  difficulty: EASY\n");
            writer.write("  exp_reward: 200\n");
            writer.write("  rep_reward: 20\n\n");
            
            writer.write("clan_master:\n");
            writer.write("  name: \"Clan Master\"\n");
            writer.write("  description: \"Reach level 5 with your clan\"\n");
            writer.write("  category: PROGRESSION\n");
            writer.write("  difficulty: HARD\n");
            writer.write("  exp_reward: 1000\n");
            writer.write("  rep_reward: 100\n\n");
            
            // Territory achievements
            writer.write("# Territory achievements\n");
            writer.write("first_claim:\n");
            writer.write("  name: \"Stake Your Claim\"\n");
            writer.write("  description: \"Claim your first territory\"\n");
            writer.write("  category: TERRITORY\n");
            writer.write("  difficulty: EASY\n");
            writer.write("  exp_reward: 100\n");
            writer.write("  rep_reward: 10\n\n");
            
            writer.write("territory_empire:\n");
            writer.write("  name: \"Territorial Empire\"\n");
            writer.write("  description: \"Own 20 territory chunks\"\n");
            writer.write("  category: TERRITORY\n");
            writer.write("  difficulty: HARD\n");
            writer.write("  exp_reward: 800\n");
            writer.write("  rep_reward: 80\n\n");
            
            writer.close();
            plugin.getLogger().info("Default achievements.yml created successfully.");
        } catch (IOException e) {
            plugin.getLogger().severe("Failed to create default achievements.yml: " + e.getMessage());
        }
    }
