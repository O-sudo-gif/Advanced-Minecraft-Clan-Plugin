...
public class Achievement {
    ...
    /**
     * Gets any custom reward text for this achievement.
     * 
     * @return The custom reward text, or null if none
     */
    public String getReward() {
        ...
        // Default reward string based on standard rewards
        return experienceReward + " XP, " + reputationReward + " Reputation";
    }
    
    /**
     * Sets a custom reward for this achievement.
     * 
     * @param customReward The custom reward text
     */
