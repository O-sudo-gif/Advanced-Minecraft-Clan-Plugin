...
public class Flag {
    ...
    private String name; // Optional name for the flag
    ...
    /**
     * Creates a flag from stored data with a name
     */
    public Flag(Location location, UUID placedBy, long placedTime, int tier, int influenceRadius, String name) {
        this.location = location.clone();
        this.placedBy = placedBy;
        this.placedTime = placedTime;
        this.tier = tier;
     ...
     * 
     * @return The flag name, or null if not set
     */
